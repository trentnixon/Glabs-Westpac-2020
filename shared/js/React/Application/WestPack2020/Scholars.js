...
const Scholars = (props)=>{
    ...
    useEffect(()=>{
        console.log("Scholar", ScholarSelected)
                 ...
                 <button className="BackToList" onClick={()=>{ setScholarSelected(false)}}>Scholar List</button>
                    ...
                    <div className="Details">
                        ...
                        <div className="Meta">
                            ...
                            <h2><strong>Awarded : </strong>{ScholarSelected.Date}</h2>
                        </div>
                        <ShowImage SupportingImage={ScholarSelected.SupportingImage}/>
                       <ShowVideo VideoID={ScholarSelected.VideoID}/>
     ...
     if(props.VideoID){
        return(
            <div className='player-wrapper'>
                <YouTube videoId={props.VideoID} opts={opts} className="YTVideoPlayer"  onReady={_onReady} />
            </div>
        )
     }else{
         return null
...
const ShowImage = (props) =>{
    ...
    if(props.SupportingImage){
        return(
            <div className='SupportingImage'>
                <img src={props.SupportingImage} alt="Supporting Image" />
            </div>
        )
    }else{
        return null
